...
export const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, options, onValueChange, defaultValue, value, ...props }, ref) => {
    // Determine if controlled or uncontrolled
    const isControlled = value !== undefined;
    
    // Extract error styling from className if present
    ...
    return (
      <div className={cn("relative inline-block w-full")}>
        <select
          ref={ref}
