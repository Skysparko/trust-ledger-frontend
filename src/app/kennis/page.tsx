...
export default function KennisPage() {
  const { posts: knowledge, isLoading } = usePosts({ category: "Knowledge" });
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-white via-zinc-50 to-white dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12">
        ...
        {isLoading ? (
          <div className="text-center py-12 text-zinc-500">Loading knowledge articles...</div>
        ) : knowledge.length === 0 ? (
          <div className="text-center py-12 text-zinc-500">No knowledge articles found.</div>
        ) : (
          <motion.div
